...
CREATE TABLE `sys_operate_log`  (
  `oper_id` int NOT NULL AUTO_INCREMENT COMMENT '操作日志ID',
  `create_time` datetime NOT NULL COMMENT '创建时间',
...
CREATE TABLE `sys_user`  (
  ...
  `passwd` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '密码',
